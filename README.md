...
* [Efficient Algorithm For K-Point Folding](https://arxiv.org/abs/1809.10261) discusses in detail an $\mathcal O(N)$ algorithm for k-point symmetry reduction. This algorithm is essential to enable the on-the-fly method in the paper above.
